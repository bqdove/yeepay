...
class Util {
    ...
    public static function getPostData($post,$needRequestHmac,$needRequest) {
        //生成签名
        $hmacData["customernumber"] = '10000447996';
        ...
        $hmac = self::getHmac($hmacData, 'jj3Q1h0H86FZ7CD46Z5Nr35p67L199WdkgETx85920n128vi2125T9KY2hzv');
        $dataMap["customernumber"] = '10000447996';//商户号
        ...
        $data = self::getAes($dataJsonString, substr('jj3Q1h0H86FZ7CD46Z5Nr35p67L199WdkgETx85920n128vi2125T9KY2hzv', 0, 16));
        $postfields = array("customernumber" => '10000447996', "data" => $data);
        return $postfields;
    }
